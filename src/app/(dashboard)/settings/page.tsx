  ...
  return (
    <div className="space-y-4 sm:space-y-6">
      ...
      <Card>
        ...
        <CardContent>
          {!hotels?.length ? (
            <p className="text-gray-500 dark:text-gray-400 text-sm">No hotels configured</p>
          ) : (
      ...
      <Card>
        ...
        <CardContent className="space-y-3">
          <div className="p-3 sm:p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
            ...
            <p className="text-xs sm:text-sm font-mono text-gray-900 dark:text-white mt-1 break-all">
